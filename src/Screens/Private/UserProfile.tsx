  ...
  return (
    ...
    <>
      ...
      {/* <Box>
          ...
          <LinearGradient
            colors={[COLORS.primary, COLORS.NewPrimary]}
            start={{x: 0, y: 0}}
            end={{x: 0, y: 1}}
            style={{
              height: 100,
            ...
            <VStack alignItems="center">
              <Text fontFamily="Montserrat-SemiBold" color="$white">
                Raj Gupta
              </Text>
              <Text
      ...
      <Box flex={1}>
        <Box position="relative">
          <Image
            source={{
              uri: 'https://images.unsplash.com/photo-1491349174775-aaafddd81942?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fHBlcnNvbnwwfHwwfHx8MA%3D%3D',
            }}
            alt="image"
          ...
          <LinearGradient
            ...
            <VStack
              ...
              <Text fontFamily="Montserrat-SemiBold" fontSize={13} color="#fff">
                Bihar
              </Text>
            </VStack>
          </LinearGradient>
        ...
        <Box
          ...
          top={-15}>
          <Box p={5}>
            <Text fontFamily="Montserrat-SemiBold" fontSize={16}>
              About
            </Text>
            <Text fontSize={14}>
              Hello, I am a mobile application developer
            </Text>
          </Box>
        </Box>
      </Box>
